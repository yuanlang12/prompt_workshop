...
async def rename_project(project_id: str, new_name: str, supabase_db) -> Dict[str, Any]:
    """
    增强的项目重命名功能
    ...
    # 使用现有的方法重命名项目
    return await supabase_db.update_project(project_id, name=new_name)

async def delete_project_with_history(project_id: str, supabase_db) -> bool:
    """
